-- AlterTable
ALTER TABLE "audit_logs" ADD COLUMN     "hash" VARCHAR(128),
ADD COLUMN     "prev_hash" VARCHAR(128),
ADD COLUMN     "signature" VARCHAR(255);

-- AlterTable
ALTER TABLE "patient_contacts" ADD COLUMN     "value_bi" VARCHAR(64),
ADD COLUMN     "value_enc" TEXT;

-- AlterTable
ALTER TABLE "patients" ADD COLUMN     "first_name_bi" VARCHAR(64),
ADD COLUMN     "first_name_enc" TEXT,
ADD COLUMN     "last_name_bi" VARCHAR(64),
ADD COLUMN     "last_name_enc" TEXT,
ADD COLUMN     "middle_name_bi" VARCHAR(64),
ADD COLUMN     "middle_name_enc" TEXT,
ADD COLUMN     "passport_number_bi" VARCHAR(64),
ADD COLUMN     "passport_number_enc" TEXT;

-- AlterTable
ALTER TABLE "user_sessions" ADD COLUMN     "mfa_satisfied_at" TIMESTAMPTZ(6),
...
-- CreateIndex
CREATE UNIQUE INDEX "encryption_keys_tenant_id_version_key" ON "encryption_keys"("tenant_id", "version");

-- CreateIndex
CREATE INDEX "audit_logs_tenant_id_hash_idx" ON "audit_logs"("tenant_id", "hash");

-- CreateIndex
CREATE INDEX "patient_contacts_tenant_id_value_bi_idx" ON "patient_contacts"("tenant_id", "value_bi");

-- CreateIndex
CREATE INDEX "patients_tenant_id_first_name_bi_idx" ON "patients"("tenant_id", "first_name_bi");

-- CreateIndex
CREATE INDEX "patients_tenant_id_last_name_bi_idx" ON "patients"("tenant_id", "last_name_bi");
